...
public class Constants {
    public static final String HEROES_BASE_URL = "https://www.hotslogs.com/API/Data/Heroes";
    public static final String MAPS_BASE_URL = "https://www.hotslogs.com/API/Data/Maps";
